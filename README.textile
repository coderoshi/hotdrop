...
This is the same. Example in the git repository "test.html". It has been tested in the following browsers:
...
It doesn't yet work in IE 7. 

Testing other OS/browser combinations would be great.